...
To support collaboration and make my workflow more accessible, I bundles my custom functions into two R packages: 
...
If you run into any issues, have questions, or just want to connect, don't hesitate to reach  out! You can open an issue on t[GitHub](https://github.com/larscaspersen/vignette_custom_phenoflex) or email me (or my supervisor Eike Luedeling). Details are on the left-hand side of the page. 
